...
>(({ className, ...props }, ref) => {
  ...
  React.useEffect(() => {
    const updateContainer = () => {
        const fsContainer = document.querySelector('[data-fullscreen-container="true"]') as HTMLElement | null;
        setPortalContainer(fsContainer);
    };
  ...
  const viewport = (
    <ToastPrimitives.Viewport
      ref={ref}
      className={cn(
        // Base styles for all toasts: bottom-right
        "fixed bottom-0 right-0 z-[100] flex w-full flex-col-reverse p-4 md:max-w-[420px]",
        // If in fullscreen, make it absolute to the container
