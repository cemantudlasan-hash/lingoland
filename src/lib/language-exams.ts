...
export const languageExams: Record<string, ExamQuestion[]> = {
  thai: [
    ...
    {
      id: 'th-ex-26',
      question: 'What is the Thai word for "Father"?',
      options: ['แม่ (Mae)', 'พี่ (Phi)', 'พ่อ (Pho)', 'น้อง (Nong)'],
      answerIndex: 2,
      explanation: 'พ่อ (Pho) is Father; แม่ (Mae) is Mother.'
    },
    {
      id: 'th-ex-27',
      question: 'What is the Thai word for "Older sibling"?',
      options: ['น้อง (Nong)', 'พี่ (Phi)', 'พ่อ (Pho)', 'แม่ (Mae)'],
      answerIndex: 1,
      explanation: 'พี่ (Phi) refers to an older sibling, while น้อง (Nong) refers to a younger sibling.'
    },
    {
      id: 'th-ex-28',
  ...
  korean: [
    ...
    {
      id: 'ko-ex-26',
      question: 'What is the word for "Older brother" when spoken by a female?',
      options: ['형 (Hyeong)', '오빠 (Oppa)', '누나 (Nuna)', '언니 (Eonni)'],
      answerIndex: 1,
      explanation: '오빠 (Oppa) is used by females for older brothers or older males; males use 형 (Hyeong).'
    },
    {
      id: 'ko-ex-27',
      question: 'What does "아이고" (Aigo) mean?',
      options: ['Oh my / Goodness / Oops', 'Excuse me', 'Thank you', 'Awesome'],
      answerIndex: 0,
      explanation: '아이고 (Aigo) is an exclamation expressing surprise, sighing, or frustration.'
    },
    {
      id: 'ko-ex-28',
  ...
  japanese: [
    ...
    {
      id: 'ja-ex-26',
      question: 'How do you say "Please eat" in Japanese?',
      options: ['食べてください (Tabete kudasai)', '飲むください (Nomu kudasai)', '行きます (Ikimasu)', 'しなさい (Shinasai)'],
      answerIndex: 0,
      explanation: '食べて (tabete) is te-form of taberu; + ください (kudasai) means "please eat".'
    },
    {
      id: 'ja-ex-27',
      question: 'Which particle indicates direction or time in Japanese?',
      options: ['に (ni)', 'を (o)', 'は (wa)', 'が (ga)'],
      answerIndex: 0,
      explanation: 'に (ni) is used for time points and destination direction.'
    },
    {
      id: 'ja-ex-28',
  ...
  french: [
    ...
    {
      id: 'fr-ex-26',
      question: 'What is the verb meaning "to have" in French?',
      options: ['être', 'avoir', 'aller', 'faire'],
      answerIndex: 1,
      explanation: 'avoir is the French auxiliary verb meaning "to have".'
    },
    {
      id: 'fr-ex-27',
      question: 'What does "les enfants" translate to?',
      options: ['the teachers', 'the children', 'the babies', 'the parents'],
      answerIndex: 1,
      explanation: 'les enfants means "the children".'
    },
    {
      id: 'fr-ex-28',
  ...
  spanish: [
    ...
    {
      id: 'es-ex-26',
      question: 'What does "tener calor" mean?',
      options: ['to have a fever', 'to be hot', 'to be cold', 'to have luck'],
      answerIndex: 1,
      explanation: 'tener calor means to feel hot.'
    },
    {
      id: 'es-ex-27',
      question: 'Which verb ending group is represented by "vivir"?',
      options: ['-ar', '-er', '-ir', '-or'],
      answerIndex: 2,
      explanation: 'vivir ends in -ir.'
    },
    {
      id: 'es-ex-28',
  ...
  chinese: [
    ...
    {
      id: 'zh-ex-26',
      question: 'How do you say "Too expensive!" in Mandarin?',
      options: ['duōshǎo qián', 'tài guì le! (太贵了)', 'piányi yīdiǎn', 'hóngbāo'],
      answerIndex: 1,
      explanation: 'tài guì le translates to "Too expensive!".'
    },
    {
      id: 'zh-ex-27',
      question: 'How do you request a discount politely ("Cheaper a bit")?',
      options: ['tài guì le', 'piányi yīdiǎn (便宜一点)', 'duōshǎo qián', 'mǎidān'],
      answerIndex: 1,
      explanation: 'piányi means cheap; yīdiǎn means a bit.'
    },
    {
      id: 'zh-ex-28',
  ...
  vietnamese: [
    ...
    {
      id: 'vi-ex-26',
      question: 'What is the Vietnamese popular "motorbike taxi" service called?',
      options: ['Xích lô', 'Xe ôm', 'Xe buýt', 'Taxi'],
      answerIndex: 1,
      explanation: 'Xe ôm literally translates to "hug vehicle" and represents a motorbike taxi.'
    },
    {
      id: 'vi-ex-27',
      question: 'What does "bến xe" mean?',
      options: ['Airport', 'Bus/Train station', 'Market', 'Hotel'],
      answerIndex: 1,
      explanation: 'bến xe refers to a bus terminal or coach station.'
    },
    {
      id: 'vi-ex-28',
