...
export const gameComponentMap = {
      ...
      'cellular-explorer-3d': dynamic(() => import('@/components/games/cellular-explorer-3d').then(mod => mod.CellularExplorer3D), { ssr: false }),
      'geometry-galaxy-3d': dynamic(() => import('@/components/games/geometry-galaxy-3d').then(mod => mod.GeometryGalaxy3D), { ssr: false }),
      ...
      'exploration-quest-3d': dynamic(() => import('@/components/games/exploration-quest-3d').then(mod => mod.ExplorationQuest3D), { ssr: false }),
      'living-puzzles-3d': dynamic(() => import('@/components/games/living-puzzles-3d').then(mod => mod.LivingPuzzles3D), { ssr: false }),
      'character-conversations-3d': dynamic(() => import('@/components/games/character-conversations-3d').then(mod => mod.CharacterConversations3D), { ssr: false }),
      'ai-storyteller-adventure': dynamic(() => import('@/components/games/ai-storyteller-adventure').then(mod => mod.AiStorytellerAdventure)),
      'vocab-flipper-3d': dynamic(() => import('@/components/games/vocab-flipper-3d').then(mod => mod.VocabFlipper3D), { ssr: false }),
